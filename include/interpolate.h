...
void get_delta_delay_relativistic(const propSimulation *propSim, const real &t, const std::vector<real> &targetState, const Constants &consts, real &deltaDelayRelativistic);

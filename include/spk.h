...
int assist_spk_calc(struct spk_s *pl, double jde, double rel, int m, double* GM, double* x, double* y, double* z, double* out_vx, double* out_vy, double* out_vz);
...
int assist_jpl_calc(struct jpl_s *pl, double jd_ref, double jd_rel, int body, double* const GM, double* const x, double* const y, double* const z, double* const vx, double* const vy, double* const vz, double* const ax, double* const ay, double* const az);

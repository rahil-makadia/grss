...
void force_thruster(const std::vector<real> &velAll, std::vector<real> &accInteg, const ForceParameters &forceParams, const IntegrationParameters &integParams, const Constants &consts){
    real vx, vy, vz;
    real ax, ay, az;
